...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.excerpt_html'
        db.add_column('coltrane_entry', 'excerpt_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Entry.body_html'
        db.add_column('coltrane_entry', 'body_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.excerpt_html'
        db.delete_column('coltrane_entry', 'excerpt_html')

        # Deleting field 'Entry.body_html'
        db.delete_column('coltrane_entry', 'body_html')
